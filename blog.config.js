...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '刘大大', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个对人工智能充满好奇心的程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zdlead.top', // 网站地址

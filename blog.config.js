...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '10c12b193a6a80eebbdfcac1a887905f,en:10c12b193a6a80eebbdfcac1a887905f',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '刘大大AI', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个会使用AI提效的程序员', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.liudada.ai', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '刘大大AI, 博客', // 网站关键词 英文逗号隔开
  ...
  CONTACT_XIAOHONGSHU: process.env.NEXT_PUBLIC_CONTACT_XIAOHONGSHU || 'https://www.xiaohongshu.com/user/profile/657b2818000000001902d408', // 小红书主页
